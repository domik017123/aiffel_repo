...
class Im2LatexDataset:
    ...
    def prepare_data(self, batch):
        ...
        return tok, images #, paths #### paths for logging
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--images', type=str, default='./dataset/data/train_data', help='Image folder')
    parser.add_argument('-e', '--equations', type=str, default='./dataset/math.txt', help='equations text file')
    parser.add_argument('-t', '--tokenizer', default='./dataset/tokenizer.json', help='Pretrained tokenizer file')
    parser.add_argument('-o', '--out', default='./dataset/data/train_pkl/train_data.pkl', help='output file')
    args = parser.parse_args()

    print('Generate dataset')
    Im2LatexDataset(args.equations, args.images, args.tokenizer).save(args.out)

    args.images = './dataset/data/val_data'
    args.out = './dataset/data/val_pkl/val_data.pkl'
    Im2LatexDataset(args.equations, args.images, args.tokenizer).save(args.out)

    args.images = './dataset/data/test_data'
    args.out = './dataset/data/test_pkl/test_data.pkl'
    Im2LatexDataset(args.equations, args.images, args.tokenizer).save(args.out)
